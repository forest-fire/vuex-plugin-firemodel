import { addedLocally, reset, serverConfirms, serverEvents, serverRollbacks, watchEvents } from '../private';
 ...
 */
propOffset) {
    const mutations = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, addedLocally(propOffset)), AbcFiremodelMutation(propOffset)), serverEvents(propOffset)), serverRollbacks(propOffset)), serverConfirms(propOffset)), watchEvents(propOffset)), reset(propOffset));
    return mutations;
}
