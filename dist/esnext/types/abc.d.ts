...
export declare type IAbcDiscreteRequest<T extends Model> = IPrimaryKey<T>[];
...
export declare function isDiscreteRequest<T>(request: IAbcDiscreteRequest<T> | IAbcConfiguredQuery<T>): request is IAbcDiscreteRequest<T>;
