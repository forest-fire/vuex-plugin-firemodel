...
import { IAuthPersistenceStrategy, IFiremodelState } from "./";
...
export declare type IFmLifecycleEvent = "connected" | "disconnected" | "logged-in" | "logged-out" | "user-upgraded" | "user-abandoned" | "route-changed";
