...
exports.recordLocal = {
    [firemodel_1.FmEvents.RECORD_CHANGED_LOCALLY]({ commit, rootState }, payload) {
    ...
    [firemodel_1.FmEvents.RECORD_ADDED_LOCALLY]({ commit, rootState }, payload) {
        const payloadPlus = Object.assign({}, payload, { priorValue: lodash_get_1.default(rootState, payload.localPath) });
    ...
    [firemodel_1.FmEvents.RECORD_REMOVED_LOCALLY]({ commit }, payload) {
