import { FmConfigAction, IFiremodelConfig, IVuexState, coreServices, queueLifecycleEvents, setInitialState, storeDatabase, storePluginConfig } from "./private";
import { FiremodelModule } from "@/types";
